...
import kr.ac.bokgpt.security.dto.OAuthAttributes;
import kr.ac.bokgpt.security.dto.SessionMember;
...
public class CustomOAuthService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    public CustomOAuthService(MemberRepository memberRepository, HttpSession httpSession) {
